...
result$indicator_df
```
The built‑in shmi_example dataset has already been processed through `prepare_shmi_inputs()`, 
so it can be passed directly to `build_shmi()`.
...
This file contains **realistic management data** and is ready to use immediately.
