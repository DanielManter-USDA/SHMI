...
The Soil Health Management Index (SHMI) provides a quantitative, rotation‑scale assessment of soil health management practices. It integrates four biologically grounded pillars:
...
This vignette provides a complete walkthrough of the SHMI workflow using the functions in the SHMI R package.
