...
The SHMI Diversity subindex quantifies the diversity of crops grown across an entire rotation, accounting for both **species identity** and **time in the field**. Diversity is computed using **entropy‑based Hill numbers**, which generalize richness, Shannon entropy, and Simpson entropy into a unified framework.
